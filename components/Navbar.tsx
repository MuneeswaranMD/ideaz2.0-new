      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/contact"
              className="bg-indigo-600 text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-500/20"
            >
              Get a Quote
            </Link>
          </div>
        ...
        <div className="px-4 pt-2 pb-6 space-y-1 sm:px-3 text-center">
          ...
          <div className="pt-4">
            <Link
              to="/contact"
              onClick={() => setIsOpen(false)}
              className="inline-block bg-indigo-600 text-white px-10 py-3 rounded-full text-md font-bold hover:bg-indigo-700 transition-all"
            >
              Get a Quote
            </Link>
          </div>
