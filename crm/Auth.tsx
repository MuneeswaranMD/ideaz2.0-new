                ...
                <div className="glass-card p-8 md:p-10 rounded-[40px] border border-white/5">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            disabled={loading}
                            type="submit"
                            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-5 rounded-2xl shadow-xl shadow-indigo-500/20 transition-all flex items-center justify-center group"
                        >
                            {loading ? 'Processing...' : (isLogin ? 'Initialize Dashboard' : 'Create Admin Account')}
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 text-center">
                        ...
                        >
                            {isLogin ? "System expansion needed? Request account" : "Existing admin? Return to base"}
                        </button>
                    </div>
                </div>
